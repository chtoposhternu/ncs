...
public class Lab3 {
    ...
    public static final String PROB = "src/main/java/probabilities.txt";
    public static final String MATRIX = "src/main/java/matrix.txt";
    ...
    public static void main(String[] args) throws IOException {
        ...
        calcLab3(lab2Res, matrix, probs, 2, 3, 912, "all");
        calcLab3(lab2Res, matrix, probs, 2, 3, 912, "alone");
    }
    ...
    private static List<Double> getPsInput(final List<List<Integer>> matrix) throws FileNotFoundException {
        List<String> input = Arrays.asList(
                new Scanner(
                        new File(new File(Lab3.PROB).getPath()))
    ...
    private static List<List<Integer>> getMatrixInput() throws IOException {
        ...
        List<String> input = Arrays.asList(
                new Scanner(
                        new File(new File(Lab3.MATRIX).getPath()))
                        .useDelimiter("\\Z").next().split("\\r?\\n")
        );
        input
